...
- `docker run -p 3000:3000 --add-host=database:172.20.0.1 container_id`, где **-p** матчинг внутреннего порта контейнера с внешни, **--add-host** - линк контейнера к внешнему контейнеру с базой данных
